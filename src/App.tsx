  ...
  return (
    <>
        ...
        <div className="h-[500px]" />
              ...
              <div className="fixed right-0 top-[calc(60vw-50px)] md:top-0 w-full md:w-3/5 md:min-h-[100vh] flex flex-col md:gap-12 justify-center md:pr-24 pt-12 pointer-events-none" ref={infoCardsRef}>
                <div className="flex flex-col items-start gap-4 md:gap-6 m-6">
                 <InfoCard
                  title="Klare Standards und transparentes Monitoring"
                  ...
                  />
                  <InfoCard
                  title="Mitarbeiter stärken und Kosten senken"
          ...
          <InfoCard
            title="Kundenqualität"
                  ...
                  />
                  <InfoCard
                  title="Serviceorientierung die Kundenzufriedenheit maximiert"
      ...
      >
          ...
          PROZESSMANAGEMENT
              ...
              <InfoCard
                ...
                />
                <InfoCard
                  title="Digitalisierung von Prozessen für mehr Produktivität"
                ...
                />
          <InfoCard
                  title="Schnittstellen klar definieren und harmonisieren"
          ...
          />
          <InfoCard
                  title="Effiziente Ressourcennutzung und Kostensenkung"
                  icon={<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><g fill="none" stroke="#d6ba6d" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"><path d="m12 17l-2 2l2 2"/><path d="M10 19h9a2 2 0 0 0 1.75-2.75l-.55-1M8.536 11l-.732-2.732L5.072 9"/><path d="m7.804 8.268l-4.5 7.794a2 2 0 0 0 1.506 2.89l1.141.024M15.464 11l2.732.732L18.928 9"/><path d="m18.196 11.732l-4.5-7.794a2 2 0 0 0-3.256-.14l-.591.976"/></g></svg>}
          />
        </div>
              </div>
      </section>
      ...
      >
          ...
          LIEFERANTENAUFBAU
              ...
              <div className="fixed right-0 top-[calc(60vw-50px)] md:top-0 w-full md:w-3/5 md:min-h-[100vh] flex flex-col md:gap-12 justify-center md:pr-24 pt-12 pointer-events-none" ref={lieferantenCardsRef}>
                ...
                <div className="flex flex-col items-start gap-4 md:gap-6 m-6">
                  <InfoCard
                  title="Auswahl und Entwicklung zuverlässiger Lieferanten"
                  ...
                  />
                  <InfoCard
                  title="Aufbau langfristiger, strategischer Partnerschaften"
                  ...
                  />
                  <InfoCard
                  title="Integration von Lieferanten in interne Qualitäts- und Prozessstandards"
                  ...
                  />
          <InfoCard
                  title="Kontinuierliches Monitoring und Risikomanagement"
      ...
      {/* Persönliche "Me"-Seite für Merab */}
            <section id="about" className="backdrop-blur-md flex w-full h-auto min-h-[120vh] relative z-50 flex-col md:flex-row items-center justify-center py-12 md:py-24 bg-neutral-700/70">
        ...
        />
              ...
              <div className="absolute bottom-3 backdrop-blur-md z-20 w-full max-w-[calc(100vw-2rem)] md:max-w-[33vw] mx-auto bg-neutral-700/70 rounded-3xl shadow-2xl p-6 md:p-8 border border-[#d6ba6d]/30 flex flex-col gap-6 md:gap-12 md:ml-[40vw] md:static md:flex-row md:items-center md:justify-center">
                <div className="flex-1 flex flex-col justify-center items-start gap-4 md:gap-6 px-2">
                  <h1 className="text-2xl md:text-5xl font-regular text-[#d6ba6d] drop-shadow-gold mb-1 md:mb-2">Merab Torodadze</h1>
                  <h2 className="text-base md:text-2xl font-regular text-gray-200 mb-2 md:mb-4">Interim Manager</h2>
                  <p className="text-sm md:text-lg text-gray-300 max-w-xl mb-2 md:mb-4">
