  ...
  return (
    <main className="min-h-screen flex flex-col justify-between bg-neutral-900 text-gray-100 px-4 py-0 pt-24">
      <div className="mx-auto mt-16 max-w-2xl w-full">
        ...
        <p className="mb-2">Merab Tedoradze<br />Werastr. 126<br />70190 Stuttgart<br />Deutschland</p>
        <p className="mb-2">Telefon: <a href="tel:+491777376989" className=" hover:text-gray-100">+49 177 7376989</a><br /> E-Mail: <a href="mailto:merab.tedoradze@mindacross.de" className=" hover:text-gray-100">merab.tedoradze@mindacross.de</a></p>
